export const SITE = {
  ...
  // its own Article/Service JSON-LD. Slugs feed the sitemap generator too.
  speakingTopics: [
    {
      slug: "grief-and-inheritance",
      title: "Grief and Inheritance",
      subtitle: "What we carry when we lose a parent.",
      audience: "Cultural centers, literary festivals, grief-adjacent programming, higher-ed.",
      blurb:
    ...
    },
    {
      ...
      keywords: ["latin american art", "immigration law", "artist visas", "cultural policy"],
    },
  ] as const,
};
