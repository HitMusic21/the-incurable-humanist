"""
Contract tests for /stories/* against the actual Sprint 2 implementation.

The sibling `test_stories_api.py` is a spec-driven skeleton predating the
implementation and may drift from the shipped contract; this file exercises
the endpoints that actually exist. When the spec file is reconciled, delete
this one.

Requires a reachable DB (same pattern as other contract tests).
"""
...
class TestAuthoredMutation:
    ...
    def test_full_crud_lifecycle(self, client, author_token):
        ...
        # Public GET now returns it + increments view_count
